...
import models.{FindRecipesParams, Flavor, Recipe, RecipeEntity, RecipeRepository}
...
class RecipeServiceSpec extends PlaySpec
  ...
  "RecipeService" should {
    "find recipes with parameters" in {
      ...
      val recipes = Seq(testRecipe, testRecipe.copy(id = Some(2L), name = "Another Fruit Mix"))
